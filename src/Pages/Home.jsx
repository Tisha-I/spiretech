        ...
        <section className="hero" id="hero">
          <div className="wrap hero-grid">
            <div>
              ...
              <h1>A professional website, <span className="hl">ready for your business.</span></h1>
              <p className="desc">Choose a professionally designed website and we'll customise it with your brand, content and business information.</p>
          ...
          <div className="wrap faq-inner">
            ...
            <div className="faq-list">
              <div className={`faq-item ${openIndex === 0 ? "open" : ""}`}>
                ...
                <div className="faq-a">
                  <p>
                    Yes. Every website is customised with your branding, colours, content
                    and images before it goes live.
                  </p>
                </div>
              </div>
              ...
              <div className={`faq-item ${openIndex === 1 ? "open" : ""}`}>
                ...
                <div className="faq-a">
                  <p>
                    Yes. Beyond the standard customisation, you can request extra features
              ...
              <div className={`faq-item ${openIndex === 2 ? "open" : ""}`}>
                ...
                <div className="faq-a">
                  <p>
                    Because you're starting from a ready-made design, most websites are
                    customised and ready much faster than a build from scratch.
                  </p>
                </div>
              </div>
              ...
              <div className={`faq-item ${openIndex === 3 ? "open" : ""}`}>
                ...
                <div className="faq-a">
                  <p>
                    You'll provide your business details, images and copy — we'll guide you
                    on exactly what's needed and help fit it into the design.
                  </p>
                </div>
              </div>
              ...
              <div className={`faq-item ${openIndex === 4 ? "open" : ""}`}>
                ...
                <div className="faq-a">
                  <p>
                    Yes. We can help connect your domain and deploy your website so it's
                    live and ready for visitors.
                  </p>
                </div>
              </div>
